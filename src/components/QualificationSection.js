...
const QualificationsSection = () => {
  ...
  return (
    <section id="qualifications" className="w-full min-w-0 mb-16 bg-white rounded-xl shadow-md overflow-hidden">
      <div className="p-8">
        <h2 className="text-3xl font-bold mb-6 text-orange-500 border-b border-gray-200 pb-2">Qualifications</h2>
        ...
        <div className="mb-8">
              ...
              <div key={index} className="border-l-4 border-orange-600 pl-4">
                ...
                {Array.isArray(item.description)
                  ? item.description.map((desc, i) => (
                      <p key={i} className="text-gray-500 mt-2">{desc}</p>
                    ))
          ...
          <br></br>
          <h3 className="text-xl font-bold mb-4 text-gray-800">Microsoft Certifications</h3>
          <div className="space-y-6">
            {ms.map((item, index) => (
              <div key={index} className="border-l-4 border-orange-600 pl-4">
                <div className="flex justify-between items-start">
